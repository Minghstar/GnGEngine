      ...
      <div className="max-w-screen-xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              Built by student-athletes for student-athletes. Connecting Australia's talent with global opportunities.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between space-y-6 sm:space-y-0">
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/directory" className="text-gray-400 hover:text-accent-blue transition-colors text-sm">
                    Explore Athletes
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <a href="#how-it-works" className="text-gray-400 hover:text-accent-blue transition-colors text-sm">
                    How It Works
                  </a>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li>
                  <a href="mailto:hello@gngengine.com" className="text-gray-400 hover:text-accent-blue transition-colors text-sm">
                    Contact
                  </a>
                </li>
                <li>
                  <a href="/privacy" className="text-gray-400 hover:text-accent-blue transition-colors text-sm">
                    Privacy
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-gray-400 hover:text-accent-blue transition-colors text-sm">
                    Terms
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-12 pt-8 border-t border-light-gray">
          <p className="text-center text-gray-500 text-xs">
            © {new Date().getFullYear()} GNG Engine. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
